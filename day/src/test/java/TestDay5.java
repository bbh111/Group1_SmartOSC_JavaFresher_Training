...
public class TestDay5 {
    public static void main(String[] args) {
        Integer[] ar = {1, 2, 3, 4, -1, -2, -3, -4, 0};
        Exercise1.countOddNumbers(ar);

        System.out.println(String.format("Origin array: %s", Arrays.toString(ar)));
        Exercise2.exchange(ar, 0, 2);
        ...
        System.out.println(String.format("Maximal of list %s from index %d to index %d is: %s",
                Arrays.toString(ar), begin, end, Exercise3.findMax(Arrays.asList(ar), begin, end)));
