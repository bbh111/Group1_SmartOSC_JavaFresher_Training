...
public class CountDivisor {
    ...
    public synchronized int getMax_value() {
        return max_value;
    }

    public synchronized void setMax_value(int max_value) {
        this.max_value = max_value;
    }

    public synchronized int getCount_before() {
        return count_before;
    }

    public synchronized void setCount_before(int count_before) {
